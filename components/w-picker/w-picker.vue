<template>
	<view class="w-picker">
		...
		<view class="w-picker-cnt" :class="{'show':showPicker}">
			...
			<view class="w-picker-view" v-if="mode=='date'||mode=='dateTime'||mode=='dateTimeMinutes'||mode=='yearMonth'">
				<picker-view indicator-style="height: 40px;" :value="pickVal" @change="bindChange">
					...
					<picker-view-column v-if="mode=='dateTime'||mode=='dateTimeMinutes'">
			...
			<view class="w-picker-view" v-if="mode=='dateTimeHalfDay'">
				<picker-view indicator-style="height: 40px;" :value="pickVal" @change="bindChange">
					<picker-view-column>
						<view class="item" v-for="(item,index) in data.years" :key="index">{{item}}年</view>
					</picker-view-column>
					...
					<picker-view-column>
						<view class="item" v-for="(item,index) in data.halfdays" :key="index">{{item}}</view>
					</picker-view-column>
				</picker-view>
			</view>
	...
	export default {
		...
		methods:{
			...
			bindChange(val){
				...
				let year="",month="",day="",hour="",minute="",second="",halfday="",province,city,area;
				...
				switch(mode){
					...
					case "dateTimeHalfDay":
						...
						_this.resultStr=`${year+'-'+month+'-'+day+' '+halfday}`;
						break;
					case "time":
